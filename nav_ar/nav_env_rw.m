...
classdef nav_env_rw < rl.env.MATLABEnvironment
    ...
    methods
        ...
        function this = nav_env_rw()
            ...
            dstp = 2*pi/4;
            actInfo = rlFiniteSetSpec([0:dstp:((2*pi)-dstp) -1]);
            actInfo.Name = 'directed movement or stay';
        ...
        function [nextobs,rwd,dnflg,logsig] = step(this,act)
            ...
            % Update system states
             cst = logsig.cc_h(end,:)-logsig.cc_h((end-1),:);
             this.State = [cst act];
...
% loc0 = this.iniloc;
            ...
            this.Logsig = logsig;
            this.State = [zeros(1,4) 1.5*pi];%[(cc_st(:))' (cc_st(:))'];
    ...
    methods
        ...
        function updateActionInfo(this)
            dstp = 2*pi/(this.actnum-1);
            this.ActionInfo.Elements = [(0:dstp:((2*pi)-dstp)) -1];
        end
