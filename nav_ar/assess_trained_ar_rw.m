...
%%
dat = agp_tr(:,3);
agrm.rmd = nanmean(dat);
agrm.rci = bootmean(100,dat);
dat = agp_tr(:,1);
agrm.tmd = nanmean(dat);
agrm.tci = bootmean(100,dat);

dat = agp_tt(:,3);
agnt.rmd = nanmean(dat);
agnt.rci = bootmean(100,dat);
dat = agp_tt(:,1);
agnt.tmd = nanmean(dat);
agnt.tci = bootmean(100,dat);
...
save([dtpath 'agtperfs\agtAR_rw_perf' dstr '.mat'],...
